      ...
      <>
        ...
        <Stack alignItems="center" justifyContent="center" direction="row" spacing={4}>
          <Button
            variant="contained"
            color="secondary"
            onClick={handleFunctionOpen}
            disabled={addressSource.functions.length === 0}
          >
            See functions
          </Button>
          <AbiDialog
          ...
          <Button
            ...
            disabled={addressSource.events.length === 0}
          >
            See Events
          </Button>
        </Stack>
        <AbiDialog open={eventOpen} title="Event Abi" items={addressSource.events} onClose={handleEventClose} />
        <br />
